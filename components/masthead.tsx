...
const Masthead: React.FC = () => {
	...
	>
		<video autoPlay loop muted playsInline className="absolute w-full h-full object-cover">
			<source src="/assets/abstract2bg.m4v" type="video/mp4; codecs=hvc1" />	
			<source src="/assets/abstract2bg.webm" type="video/webm; codecs=vp9" />	
		...
		<div className="p-12 font-bold z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] text-center flex-1 flex items-center justify-center flex-col">
			<h1 className="mb-6 text-4xl xl:test-5xl">SAC4</h1>
			<h2 className="mb-2 text-2xl xl:test-3xl tracking-tight">
				
				
				<span>Applications Introduction,</span>{' '}<span>applications in the real world.</span>
