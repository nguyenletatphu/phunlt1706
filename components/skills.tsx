...
return (
	<div ref={refContainer} className="bg-black text-white">
		...
		<div className="leading-[1.15]">
			...
			}}>We already know that in communicating with foreigners,</div>
			<span className={`${s.skillText} inline-block after:content-['_']`} style={{ 
			opacity: opacityForBlock(progress, 1)
			}}>the ability to communicate especially in English is very important, not only for communication but also for studying and working throughout your life.</span>
			<span className={`${s.skillText} inline-block`} style={{ 
			opacity: opacityForBlock(progress, 2)
			}}>
				We will introduce you to some useful tools in <strong>improving</strong> your communication skills in English.
			</span>
			</div>
		</div>
 </div>
